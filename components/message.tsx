      ...
      {isReasoning ? (
        <div
          className={cn(
            ...
            "bg-indigo-50/50 dark:bg-indigo-900/10 slate:bg-indigo-900/20 text-indigo-700 dark:text-indigo-300 slate:text-indigo-300",
            "border border-indigo-200/50 dark:border-indigo-700/20 slate:border-indigo-600/30 w-fit"
          )}
        >
